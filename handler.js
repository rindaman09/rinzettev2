...
break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/Rindaman09/Rinzettev2'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: ' +62 857-3505-9141'
                                }
                            }, {
                                quickReplyButton: {
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By Rinzette Bot.mp3`}, { quoted : m })
            }
            break
...
`
                let btn = [{
                        ...
                        kagura.send5ButImg(m.chat, anu, `©Zette Project`, global.thumb, btn)
                        } else if (setbot.templateGif) {
                        kagura.send5ButGif(m.chat, anu, `©Zette Project`, global.visoka, btn)
                        } else if (setbot.templateVid) {
                        kagura.send5ButVid(m.chat, anu, `©Zette Project`, global.visoka, btn)
                        } else if (setbot.templateMsg) {
                        kagura.send5ButMsg(m.chat, anu, `©Zette Project`, btn)
                        }
                     }
            break
            default:
